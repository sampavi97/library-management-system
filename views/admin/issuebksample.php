                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mt-3">
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="id" name="id" size="50" value="<?php echo isset($users['id']) ? $users['id'] : ''; ?>">
                        </div>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text" for="username">Name:</span>
                            <input type="text" class="form-control" id="username" name="username" size="50" value="<?php echo isset($users['username']) ? $users['username'] : ''; ?>">
                        </div>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text" for="nic">NIC:</span>
                            <input type="text" class="form-control" id="nic" name="nic" size="50" value="<?php echo isset($users['nic']) ? $users['nic'] : ''; ?>">
                        </div>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text" for="email">Email:</span>
                            <input type="text" class="form-control" id="email" name="email" size="50" value="<?php echo isset($users['email']) ? $users['email'] : ''; ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mt-3">
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="id" name="id" size="50" value="<?php echo isset($books['id']) ? $books['id'] : ''; ?>">
                        </div>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text" for="username">Title:</span>
                            <input type="text" class="form-control" id="title" name="title" size="50" value="<?php echo isset($books['title']) ? $books['title'] : ''; ?>">
                        </div>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text" for="nic">ISBN:</span>
                            <input type="text" class="form-control" id="isbn" name="isbn" size="50" value="<?php echo isset($books['isbn']) ? $books['isbn'] : ''; ?>">
                        </div>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text" for="available_books">Available Books:</span>
                            <input type="text" class="form-control" id="available_books" name="available_books" size="50" value="<?php echo isset($books['available_books']) ? $books['available_books'] : ''; ?>">
                        </div>
                    </div>
                </div>
            </div>
